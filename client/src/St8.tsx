...
class St8Error extends Error {
  constructor(arg: unknown) {
    if (arg instanceof Error || isAxiosError(arg)) {
      super(arg.message);
...
export const St8 = {
  ...
  isError<T>(arg: St8<T>): arg is St8Error {
